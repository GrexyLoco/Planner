...
namespace Planner.UI
{
    class MasterPage : ContentPage
    {
        public MasterPage()
        {
            ...
            Image img = new Image { Source = "sonneafrica.jpg", Aspect = Aspect.AspectFit, VerticalOptions = LayoutOptions.Start, HorizontalOptions = LayoutOptions.Fill };
            StackLayout stackOptions = new StackLayout { VerticalOptions = LayoutOptions.End };
            stackOptions.Children.Add(btnOpt1);
            stackOptions.Children.Add(btnOpt2);
            stackOptions.Children.Add(btnOpt3);
            ...
            masterGrid.Children.Add(stackOptions,   0, 3);
